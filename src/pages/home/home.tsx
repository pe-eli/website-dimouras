...
import pizzaIcon from "/embreve.jpeg"; // adicione um ícone aqui

export default function Ap() {
  return (
    <div className="landing-container">
      <div className="card">
        <img src={pizzaIcon} alt="Logo" className="logo" />

        <h1 className="title">Di Mouras Pizzas e Burguers</h1>
        <p className="subtitle">Muito mais recheio! Muito mais sabor!</p>

        <button className="coming-soon">Delivery aqui em Pontevila</button>

        <p className="description">
          Nosso novo site está sendo finalizado com carinho para oferecer a melhor
          experiência ao fazer seu pedido. Enquanto isso, entre em contato conosco!
        </p>

        <div className="buttons">
          <a href="https://wa.me/5537998260420?text=Olá!%20Quero%20fazer%20um%20pedido." 
          className="whatsapp">
            <FaWhatsapp /> Peça pelo WhatsApp
          </a>
        </div>
